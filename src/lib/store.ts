...
export const editStoreName = async (
  storeId: string,
  body: EditStoreNameBody,
) => {
  try {
    const token = localStorage.getItem("token");
    if (!token) throw new Error("No token found");
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message || "Failed to edit store name.",
      );
    }
    throw new Error("An unexpected error occurred.");
  }
...
export const editLocation = async (
  ...
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message || "Failed to edit location.",
      );
    }
    throw new Error("An unexpected error occurred.");
  }
...
export const deactivateStore = async (storeId: string) => {
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message || "Failed to deactivate store.",
      );
    }
    throw new Error("An unexpected error occurred.");
  }
...
export const reactivateStore = async (storeId: string) => {
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message || "Failed to reactivate store.",
      );
    }
    throw new Error("An unexpected error occurred.");
  }
...
export const activateLocation = async (locationId: string) => {
  try {
    ...
    if (error instanceof AxiosError) {
      throw new Error(
        error.response?.data?.message || "Failed to activate location.",
      );
    }
    throw new Error("An unexpected error occurred.");
  }
