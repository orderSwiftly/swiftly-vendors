...
import { Loader2, Link2, ChevronDown, X } from "lucide-react";
            ...
            {isOpen && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        <div className="w-full max-w-md bg-(--txt-clr) rounded-xl shadow-xl border border-(--sec-clr)/20 overflow-hidden animate-in fade-in zoom-in duration-200">
                            {/* Modal Header */}
